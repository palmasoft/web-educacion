...
class SppagebuilderAddonOptin_form extends SppagebuilderAddons{
	...
	public function css() {
		...
		$use_custom_button = (isset($this->addon->settings->use_custom_button) && $this->addon->settings->use_custom_button) ? $this->addon->settings->use_custom_button : 0;
		$font_size = (isset($this->addon->settings->fontsize) && $this->addon->settings->fontsize) ? $this->addon->settings->fontsize : 0;
	...
	public static function getTemplate(){
		...
		<#
			...
			button_text = (data.button_text) ? data.button_text : Joomla.JText._("COM_SPPAGEBUILDER_ADDON_OPTIN_FORM_SUBCSCRIBE");
			...
			var button_padding = window.getMarginPadding(data.button_padding, "padding");
		...
		<div class="sppb-addon sppb-addon-optin-forms {{ data.alignment }} grid{{ grid }}">
			...
			<div class="sppb-optin-form-box sppb-row {{ raw_wrap }}">
				...
				<div class="sppb-optin-form-content {{ form_wrap }}">
					<form class="sppb-optin-form {{ forminline }}">
						<# if (!data.hide_name) { #>
