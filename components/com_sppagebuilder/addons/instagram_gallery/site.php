              ...
              for ($i=0; $i < $count; $i++) {
                $output .= '<li>';
                  $output .= ($items[$i]->images->standard_resolution->url) ? '<a class="sppb-instagram-gallery-btn" href="' .  $items[$i]->images->standard_resolution->url . '">' : '';
                     $output .= '<img class="instagram-image sppb-img-responsive" height="'.$items[$i]->images->standard_resolution->height.'" width="'.$items[$i]->images->standard_resolution->width.'" src="' . $items[$i]->images->standard_resolution->url . '" alt="">';
