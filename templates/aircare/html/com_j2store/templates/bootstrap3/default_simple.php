            ...
            <div class="content">
				...
				<?php if($this->params->get('catalog_mode', 0) == 0): ?>
					...
					<form action="<?php echo $this->product->cart_form_action; ?>"
						...
						<a href="<?php echo $this->product->product_link; ?>" class="<?php echo $this->params->get('choosebtn_class', 'btn btn-primary'); ?>"><?php echo JText::_('J2STORE_VIEW_PRODUCT_DETAILS'); ?></a>
						<?php else: ?>
						<?php echo $this->loadTemplate('cart'); ?>
						<?php endif; ?>
