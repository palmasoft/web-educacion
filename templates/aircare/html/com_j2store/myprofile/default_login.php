...
$guest_action_url = JRoute::_( "index.php?option=com_j2store&view=myprofile&task=guestentry" );
...
<div class="j2store">
	<div class="<?php echo $J2gridRow; ?>">
		...
		<div class="col-sm-6 col-lg-6 col-lg-offset-3 jb-my-profile">
			<h3>
			...
			<form
				...
				<label for="remember" class="jb-inline"> <input type="checkbox" name="remember"
