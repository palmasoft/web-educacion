...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="latest-blog-area k2ItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
                        ...
                        <div class="text">
                            ...
                            <?php if($params->get('itemReadMore') && $item->fulltext): ?>
								<a class="readmore" href="<?php echo $item->link; ?>">
									 <?php echo JText::_('K2_READ_MORE'); ?> <i class="fa fa-caret-right" aria-hidden="true"></i>
								</a>
							<?php endif; ?>
                        </div>
                    </div>
  ...
  <?php endif; ?>
	...
	<div class="more-blog-button center">
		<?php if($params->get('itemCustomLink')): ?>
			<a class="btn btn-primary" href="<?php echo $params->get('itemCustomLinkURL'); ?>" title="<?php echo K2HelperUtilities::cleanHtml($itemCustomLinkTitle); ?>"><?php echo $itemCustomLinkTitle; ?></a>
		<?php endif; ?>
	</div>
