    ...
    <div class="col-sm-6 col-sm-offset-3 text-center">
        ...
        <div class="reg-login-form-wrap">
            <div class="reg-login-title">
                <h3><?php echo JText::_('COM_USERS_REGISTRATION_TITLE'); ?></h3>
            </div>
            ...
            <div class="registration<?php echo $this->pageclass_sfx ?>">
                ...
                <p>
                    <?php echo JTEXT::_('T3_ALREADY_ACCOUNT'); ?> <a href="<?php echo JRoute::_('index.php?option=com_users&view=login'); ?>"><?php echo JText::_('T3_LOGIN'); ?></a>
                </p>
            </div>
        </div>
    </div>
